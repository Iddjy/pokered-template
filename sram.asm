...
sMainData::    ds wMainDataEnd   - wMainDataStart ; a5a3 = 2553
sSpriteData::  ds wSpriteDataEnd - wSpriteDataStart ; ad2c = 2cdc
sPartyData::   ds wPartyDataEnd  - wPartyDataStart ; af2c = 2edc
sCurBoxData::  ds wBoxDataEnd    - wBoxDataStart ; b0c0 = 3070
sTilesetType:: ds 1 ; b522 = 34d2
