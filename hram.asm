...
hDexRatingNumMonsSeenHigh  EQU $FFDB		; to handle 2 bytes species IDs
hDexRatingNumMonsSeenLow   EQU $FFDC		; to handle 2 bytes species IDs
hDexRatingNumMonsOwnedHigh EQU $FFDD		; to handle 2 bytes species IDs
hDexRatingNumMonsOwnedLow  EQU $FFDE		; to handle 2 bytes species IDs
