...
GetBattleTransitionID_WildOrTrainer:
	ld a, [wEngagedTrainerClass]			; use this instead of wCurOpponent to determine whether this is a wild or trainer battle
	and a
	jr z, .wild								; if it's null, then it's a trainer battle
	inc a
	jr z, .wild								; if it's $ff, then it's a trainer battle
	set 0, c
	ret
.wild
	res 0, c
