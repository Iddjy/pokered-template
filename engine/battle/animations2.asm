...
.afterDrawingTiles
	...
	push hl
	push de
	ld hl, AnimationsWithDuplicatedFrameBlocks	; use an array instead of comparing only to GROWL
	ld de, 1
	call IsInArray
	pop de
	pop hl
	jr c, .resetFrameBlockDestAddr
	call AnimationCleanOAM_2
...
AnimationsWithDuplicatedFrameBlocks:
	db GIGA_DRAIN
	db WATER_PULSE
	db LEAF_STORM
	db SLUDGE_BOMB
...
PlayAnimation_2:
	...
	dec a
	sub STRUGGLE		; since this bank only handles moves whose IDs are above STRUGGLE, we must subtract it to get the correct offset in the pointer table
	ld l, a
	ld h, 0
	add hl, hl
	ld de, AttackAnimationPointers_2  ; animation command stream pointers
	add hl, de
	ld a, [hli]
	ld h, [hl]
	ld l, a
...
.foundMatch
	...
	push hl
	push de
	call GetMoveSound_2			; c must not be modified between the call to GetMoveSound and the call to PlayCrySound
	ld b, a						; because PlayCrySound assumes c holds the base cry id's high byte
	call IsCryMove_2			; and GetMoveSound puts it in c as its output
	ld a, b
	jr nc, .notCryMove
	call PlayCrySound
	jr .afterPlaySound
...
.playSubanimation
	...
	ld a, [wAnimPalette]
	ld [rOBP0], a
	call LoadAnimationTileset_2
	call LoadSubanimation_2
	call PlaySubanimation_2
	pop af
	ld [rOBP0], a
...
LoadSubanimation_2:
	...
	jr nz, .isNotType5
.isType5
	call GetSubanimationTransform2_2
	jr .saveTransformation
.isNotType5
	call GetSubanimationTransform1_2
.saveTransformation
...
LoadAnimationTileset_2:
	ld a, [wWhichBattleAnimTileset]
	add a
	add a
	ld hl, AnimationTilesetPointers_2
	ld e, a
	ld d, 0
	add hl, de
	ld a, [hli]
	...
	ld hl, vSprites + $310
	ld b, BANK(AnimationTileset1_2) ; ROM bank
	ld a, [wTempTilesetNumTiles]
	ld c, a ; number of tiles
	jp CopyVideoData ; load tileset

AnimationTilesetPointers_2:
	db 79 ; number of tiles
	dw AnimationTileset1_2
	db $FF

	db 79 ; number of tiles
	dw AnimationTileset2_2
	db $FF
...
.moveAnimation
	...
	call PlayAnimation_2
	jr .next4
.animationsDisabled
	ld c, 30
	call DelayFrames
.next4
	call PlayApplyingAttackAnimation_2 ; shake the screen or flash the pic in and out (to show damage)
.animationFinished
	call WaitForSoundToFinish
	xor a
	ld [wSubAnimSubEntryAddr], a
...
.next									; this avoids the blinking making its picture reappear when hitting through invulnerability
	...
	ld c, a
	ld b, 0
	ld hl, AnimationTypePointerTable_2
	add hl, bc
	ld a, [hli]
	ld h, [hl]
	ld l, a
...
AnimationTypePointerTable_2:
	dw ShakeScreenVertically_2 ; enemy mon has used a damaging move without a side effect
	dw ShakeScreenHorizontallyHeavy_2 ; enemy mon has used a damaging move with a side effect
	dw ShakeScreenHorizontallySlow_2 ; enemy mon has used a non-damaging move
	dw BlinkEnemyMonSprite_2 ; player mon has used a damaging move without a side effect
	dw ShakeScreenHorizontallyLight_2 ; player mon has used a damaging move with a side effect
	dw ShakeScreenHorizontallySlow2_2 ; player mon has used a non-damaging move

ShakeScreenVertically_2:
	call PlayApplyingAttackSound_2
	ld b, 8
	jp AnimationShakeScreenVertically_2

ShakeScreenHorizontallyHeavy_2:
	call PlayApplyingAttackSound_2
	ld b, 8
	jp AnimationShakeScreenHorizontallyFast_2

ShakeScreenHorizontallySlow_2:
	lb bc, 6, 2
	jr AnimationShakeScreenHorizontallySlow_2

BlinkEnemyMonSprite_2:
	call PlayApplyingAttackSound_2
	jp AnimationBlinkEnemyMon_2

ShakeScreenHorizontallyLight_2:
	call PlayApplyingAttackSound_2
	ld b, 2
	jp AnimationShakeScreenHorizontallyFast_2

ShakeScreenHorizontallySlow2_2:
	lb bc, 3, 2

AnimationShakeScreenHorizontallySlow_2:
	push bc
	push bc
.loop1
	ld a, [rWX]
...
.loop2
	...
	pop bc
	dec c
	jr nz, AnimationShakeScreenHorizontallySlow_2
	ret

SetAnimationPalette_2:
	ld a, [wOnSGB]
	and a
	ld a, $e4
	jr z, .notSGB
...
.loop
	...
	ld d, 0
	ld hl, FrameBlockBaseCoords_2  ; base coordinate table
	add hl, de
	add hl, de
	ld a, [hli]
	ld [wBaseCoordY], a
	...
	ld [wFBMode], a
	call DrawFrameBlock_2
	call DoSpecialEffectByAnimationId_2 ; run animation-specific function (if there is one)
	ld a, [wSubAnimCounter]
	dec a
...
DoSpecialEffectByAnimationId_2:
	push hl
	push de
	push bc
	ld a, [wAnimationID]
	ld hl, AnimationIdSpecialEffects_2
	ld de, 3
	call IsInArray
	jr nc, .done
	inc hl
...
AnimationIdSpecialEffects_2:
	
	db AQUA_JET
	dw DoGrowlSpecialEffects_2
	...
	db LEAF_STORM
	dw DoLeafStormSpecialEffects
	
	db AVALANCHE
	dw FlashScreenEveryFourFrameBlocks_2

	db CLOSE_COMBAT
	dw AnimationFlashScreen_2
	...
	db STONE_EDGE
	dw DoBlizzardSpecialEffects_2
	
	db ANCIENTPOWER
	dw DoRockSlideSpecialEffects_2
	...
	db DRAGON_PULSE
	dw FlashScreenEveryEightFrameBlocks_2
...
DoRockSlideSpecialEffects_2:
	...
	jr nc, .shakeScreen
	cp 1
	jp z, AnimationFlashScreen_2 ; if it's the end of the subanimation, flash the screen
	ret
...
FlashScreenEverySixteenFrameBlocks:
	ld a, [wSubAnimCounter]
	and 15 ; is the subanimation counter exactly 16
	call z, AnimationFlashScreen_2 ; if so, flash the screen
	ret

FlashScreenEveryEightFrameBlocks_2:
	ld a, [wSubAnimCounter]
...
FlashScreenEveryFourFrameBlocks_2:
	ld a, [wSubAnimCounter]
	and 3
	call z, AnimationFlashScreen_2
	ret

; used for Explosion and Selfdestruct
DoExplodeSpecialEffects_2:
	ld a, [wSubAnimCounter]
	cp 1 ; is it the end of the subanimation?
	jr nz, FlashScreenEveryFourFrameBlocks_2
; if it's the end of the subanimation, make the attacking pokemon disappear
	coord hl, 1, 5
	jp AnimationHideMonPic_2 ; make pokemon disappear

; flashes the screen when subanimation counter is 1 modulo 4
DoBlizzardSpecialEffects_2:
	ld a, [wSubAnimCounter]
	cp 13
	jp z, AnimationFlashScreen_2
	cp 9
	jp z, AnimationFlashScreen_2
	cp 5
	jp z, AnimationFlashScreen_2
...
DoGrowlSpecialEffects_2:
	...
	ld a, [wSubAnimCounter]
	dec a
	call z, AnimationCleanOAM_2 ; clean up at the end of the subanimation
	ret

DoLeafStormSpecialEffects:
	call DoGrowlSpecialEffects_2
	jp FlashScreenEverySixteenFrameBlocks

; Format: Special Effect ID (1 byte), Address (2 bytes)
SpecialEffectPointers_2:
	db SE_DARK_SCREEN_FLASH ; $FE
	dw AnimationFlashScreen_2
	db SE_DARK_SCREEN_PALETTE ; $FD
	dw AnimationDarkScreenPalette_2
	db SE_RESET_SCREEN_PALETTE ; $FC
	dw AnimationResetScreenPalette_2
	db SE_SHAKE_SCREEN ; $FB
	dw AnimationShakeScreen_2
	db SE_WATER_DROPLETS_EVERYWHERE ; $FA
	dw AnimationWaterDropletsEverywhere_2
	db SE_DARKEN_MON_PALETTE ; $F9
	dw AnimationDarkenMonPalette_2
	db SE_FLASH_SCREEN_LONG ; $F8
	dw AnimationFlashScreenLong_2
	db SE_SLIDE_MON_UP ; $F7
	dw AnimationSlideMonUp_2
	db SE_SLIDE_MON_DOWN ; $F6
	dw AnimationSlideMonDown_2
	db SE_FLASH_MON_PIC ; $F5
	dw AnimationFlashMonPic_2
	db SE_SLIDE_MON_OFF ; $F4
	dw AnimationSlideMonOff_2
	db SE_BLINK_MON ; $F3
	dw AnimationBlinkMon_2
	db SE_MOVE_MON_HORIZONTALLY ; $F2
	dw AnimationMoveMonHorizontally_2
	db SE_RESET_MON_POSITION ; $F1
	dw AnimationResetMonPosition_2
	db SE_LIGHT_SCREEN_PALETTE ; $F0
	dw AnimationLightScreenPalette_2
	db SE_HIDE_MON_PIC ; $EF
	dw AnimationHideMonPic_2
	db SE_SQUISH_MON_PIC ; $EE
	dw AnimationSquishMonPic_2
	db SE_SHOOT_BALLS_UPWARD ; $ED
	dw AnimationShootBallsUpward_2
	db SE_SHOOT_MANY_BALLS_UPWARD ; $EC
	dw AnimationShootManyBallsUpward_2
	db SE_BOUNCE_UP_AND_DOWN ; $EB
	dw AnimationBoundUpAndDown_2
	db SE_MINIMIZE_MON ; $EA
	dw AnimationMinimizeMon_2
	db SE_SLIDE_MON_DOWN_AND_HIDE ; $E9
	dw AnimationSlideMonDownAndHide_2
	db SE_TRANSFORM_MON ; $E8
	dw AnimationTransformMon_2
	db SE_LEAVES_FALLING ; $E7
	dw AnimationLeavesFalling_2
	db SE_PETALS_FALLING ; $E6
	dw AnimationPetalsFalling_2
	db SE_SLIDE_MON_HALF_OFF ; $E5
	dw AnimationSlideMonHalfOff_2
	db SE_SHAKE_ENEMY_HUD ; $E4
	dw AnimationShakeEnemyHUD_2
	db SE_SHAKE_ENEMY_HUD_2 ; unused--same pointer as SE_SHAKE_ENEMY_HUD ($E4)
	dw AnimationShakeEnemyHUD_2
	db SE_SPIRAL_BALLS_INWARD ; $E2
	dw AnimationSpiralBallsInward_2
	db SE_DELAY_ANIMATION_10 ; $E1
	dw AnimationDelay10_2
	db SE_FLASH_ENEMY_MON_PIC ; unused--same as SE_FLASH_MON_PIC ($F5), but for the enemy mon
	dw AnimationFlashEnemyMonPic_2
	db SE_HIDE_ENEMY_MON_PIC ; $DF
	dw AnimationHideEnemyMonPic_2
	db SE_BLINK_ENEMY_MON ; $DE
	dw AnimationBlinkEnemyMon_2
	db SE_SHOW_MON_PIC ; $DD
	dw AnimationShowMonPic_2
	db SE_SHOW_ENEMY_MON_PIC ; $DC
	dw AnimationShowEnemyMonPic_2
	db SE_SLIDE_ENEMY_MON_OFF ; $DB
	dw AnimationSlideEnemyMonOff_2
	db SE_SHAKE_BACK_AND_FORTH ; $DA
	dw AnimationShakeBackAndForth_2
	db SE_SUBSTITUTE_MON ; $D9
	dw AnimationSubstitute_2
	db SE_WAVY_SCREEN ; $D8
	dw AnimationWavyScreen_2
	db SE_REVERSE_TURN						; $D7
	dw ReverseTurn_2
	db SE_DARKEN_MON_PALETTE_2				; $D6
	dw AnimationDarkenMonPalette2_2
	db SE_VERY_LIGHT_SCREEN_PALETTE			; $D3
	dw AnimationVeryLightScreenPalette_2
	db SE_SNOW_FLAKES_EVERYWHERE			; $D2
	dw AnimationSnowflakesEverywhere
	db SE_LEAVES_EVERYWHERE					; $D1
	dw AnimationLeavesEverywhere
	db SE_FLAMES_EVERYWHERE					; $D0
	dw AnimationFlamesEverywhere
	db SE_SLIDE_MON_DOWN_FAST				; $CE
	dw AnimationSlideMonDownFast
	db SE_BOUNCE_UP_AND_DOWN_FAST			; $CD
	dw AnimationBoundUpAndDownFast
	db SE_SHAKE_BACK_AND_FORTH_SHORT		; $CC
	dw AnimationShakeBackAndForthShort
	db SE_SNOW_FLAKES_EVERYWHERE_SHORT		; $CB
	dw AnimationSnowflakesEverywhereShort
	db $FF
...
AnimationFlashScreenLong_2:
	ld a, 3 ; cycle through the palettes 3 times
	ld [wFlashScreenLongCounter], a
	ld a, [wOnSGB] ; running on SGB?
	and a
	ld hl, FlashScreenLongMonochrome_2
	jr z, .loop
	ld hl, FlashScreenLongSGB_2
.loop
	push hl
.innerLoop
	ld a, [hli]
...
AnimationDarkScreenPalette_2:
; Changes the screen's palette to a dark palette.
	lb bc, $6f, $6f
	jr SetAnimationBGPalette_2

AnimationDarkenMonPalette_2:
; Darkens the mon sprite's palette.
	lb bc, $f9, $f4
	jr SetAnimationBGPalette_2

AnimationDarkenMonPalette2_2:
	lb bc, $fe, $f8
	jr SetAnimationBGPalette_2

AnimationResetScreenPalette_2:
; Restores the screen's palette to the normal palette.
	lb bc, $e4, $e4
	jr SetAnimationBGPalette_2

AnimationLightScreenPalette_2:
; Changes the screen to use a palette with light colors.
	lb bc, $90, $90
	jr SetAnimationBGPalette_2

AnimationVeryLightScreenPalette_2:
	lb bc, $40, $40

SetAnimationBGPalette_2:
	ld a, [wOnSGB]
	and a
	ld a, b
	jr z, .next
...
AnimationShakeScreenVertically_2:
	predef_jump PredefShakeScreenVertically

AnimationShakeScreen_2:
; Shakes the screen for a while. Used in Earthquake/Fissure/etc. animations.
	ld b, $8

AnimationShakeScreenHorizontallyFast_2:
	predef_jump PredefShakeScreenHorizontally

AnimationLeavesEverywhere:
	ld a, 1
	ld [wWhichBattleAnimTileset], a
	call LoadAnimationTileset_2
	ld b, $37							; leaf tile
	ld d, 20							; duration of the animation in frames
	jr AnimationTileEverywhere

AnimationSnowflakesEverywhereShort:
	xor a
	ld [wWhichBattleAnimTileset], a
	call LoadAnimationTileset_2
...
AnimationWaterDropletsEverywhere_2:
...
.loop
	...
	ld a, 0
	ld [wUnusedD08A], a
	call _AnimationWaterDroplets_2
	ld a, 24
	ld [wBaseCoordY], a
	ld a, 32
	ld [wUnusedD08A], a
...
.next
	...
	jp _AnimationSlideMonUp_2

AnimationSlideMonDown_2:
; Slides the mon's sprite down out of the screen.
	xor a
	call GetTileIDList_2
.loop
	call GetMonSpriteTileMapPointerFromRowCount_2
	push bc
	push de
	call CopyPicTiles_2
	call Delay3
	call AnimationHideMonPic_2
	pop de
	pop bc
	dec b
	jr nz, .loop
...
AnimationSlideMonOff_2:
; Slides the mon's sprite off the screen horizontally.
	ld e, 8
	ld a, 3
	ld [wSlideMonDelay], a
	jp _AnimationSlideMonOff_2

AnimationSlideEnemyMonOff_2:
; Slides the enemy mon off the screen horizontally.
	ld hl, AnimationSlideMonOff_2
	jp CallWithTurnFlipped_2

_AnimationSlideMonUp_2:
	push de
	push hl
	push bc
...
.fillBottomRowLoop
	...
	pop de
	dec c
	jr nz, _AnimationSlideMonUp_2
	ret

ShakeEnemyHUD_WritePlayerMonPicOAM_2:
...
.loop
	...
	ld b, 5
.innerLoop
	call BattleAnimWriteOAMEntry_2
	inc d
	dec b
	jr nz, .innerLoop
	dec c
...
AdjustOAMBlockXPos_2:
	ld l, e
	ld h, d

AdjustOAMBlockXPos2_2:
	ld de, 4
.loop
...
AdjustOAMBlockYPos_2:
	ld l, e
	ld h, d

AdjustOAMBlockYPos2_2:
	ld de, 4
.loop
	ld a, [wCoordAdjustmentAmount]
	ld b, a
...
AnimationBlinkEnemyMon_2:
; Make the enemy mon's sprite blink on and off for a second or two
	ld hl, AnimationBlinkMon_2
	jp CallWithTurnFlipped_2
...
AnimationFlashEnemyMonPic_2:
; Flashes the enemy mon's sprite on and off
	ld hl, AnimationFlashMonPic_2
	jp CallWithTurnFlipped_2

AnimationShowMonPic_2:
	xor a
	call GetTileIDList_2
	call GetMonSpriteTileMapPointerFromRowCount_2
	call CopyPicTiles_2
...
; to make the mon's sprite reappear after disappears offscreen.
	ld hl, AnimationShowMonPic_2
	jp CallWithTurnFlipped_2

AnimationShakeBackAndForthShort:
	ld c, 8
	jr AnimationShakeBackAndForth_2.gotDuration
	
AnimationShakeBackAndForth_2:
...
AnimationMoveMonHorizontally_2:
...
; Resets the mon's sprites to be located at the normal coordinates.
	...
	ld a, 11
.next
	call ClearMonPicFromTileMap_2
	jp AnimationShowMonPic_2

AnimationSpiralBallsInward_2:
...
.next
	...
	xor a
	call InitMultipleObjectsOAM_2
	ld hl, SpiralBallAnimationCoordinates_2
.loop
	push hl
	ld c, 3
	ld de, wOAMBuffer
...
.done
	pop hl
	call AnimationCleanOAM_2
	jp AnimationFlashScreen_2

SpiralBallAnimationCoordinates_2:
; y, x pairs
...
.loop
	...
	cp 0
	jr nz, .right
	call AnimCopyRowLeft_2
	dec hl
	jr .next
.right
	call AnimCopyRowRight_2
	inc hl
.next
	ld [hl], " "
	pop hl
...
.next
	...
	ld [wBaseCoordX], a
	lb bc, 5, 1
	call _AnimationShootBallsUpward_2
	jp AnimationCleanOAM_2

_AnimationShootBallsUpward_2:
	push bc
	xor a
	ld [wWhichBattleAnimTileset], a
	call LoadAnimationTileset_2
...
AnimationShootManyBallsUpward_2:
; Shoots several pillars of "energy" balls upward.
	ld a, [H_WHOSETURN]
	and a
	ld hl, UpwardBallsAnimXCoordinatesPlayerTurn_2
	ld a, $50 ; y coordinate for "energy" ball pillar
	jr z, .player
	ld hl, UpwardBallsAnimXCoordinatesEnemyTurn_2
...
UpwardBallsAnimXCoordinatesPlayerTurn_2:
...
UpwardBallsAnimXCoordinatesEnemyTurn_2:
; List of x coordinates for each pillar of "energy" balls in the
; AnimationShootManyBallsUpward animation. It's unused in the game.
	db $60, $90, $78, $68, $88, $80
	db $FF ; list terminator

AnimationMinimizeMon_2:
; Changes the mon's sprite to a mini black sprite. Used by the
; Minimize animation.
	call LoadMiniSprite_2			; replace the body of the function by this call to avoid code duplication
	call Delay3
	jp AnimationShowMonPic_2

MinimizedMonSprite_2:
	INCBIN "gfx/minimized_mon_sprite.1bpp"
MinimizedMonSpriteEnd_2:
...
LoadMiniSprite_2:
	...
	ld de, $194
	add hl, de
	ld de, MinimizedMonSprite_2
	ld c, MinimizedMonSpriteEnd_2 - MinimizedMonSprite_2
.loop
	ld a, [de]
	ld [hli], a
	ld [hli], a
	...
	dec c
	jr nz, .loop
	jp CopyTempPicToMonPic_2

AnimationSlideMonDownAndHide_2:
...
.loop
	...
	dec c
	jr nz, .loop
	jp AnimationHideMonPic_2

_AnimationSlideMonOff_2:
...
AnimationSlideMonHalfOff_2:
; Slides the mon's sprite halfway off the screen. It's used in Softboiled.
	ld e, 4
	ld a, 4
	ld [wSlideMonDelay], a
	call _AnimationSlideMonOff_2
	jp Delay3

CopyTempPicToMonPic_2:
	ld a, [H_WHOSETURN]
	and a
...
AnimationWavyScreen_2:
; used in Psywave/Psychic etc.
	ld hl, vBGMap0
	call BattleAnimCopyTileMapToVRAM_2
	call Delay3
	xor a
	...
	ld c, $ff
	ld hl, WavyScreenLineOffsets_2
.loop
	push hl
.innerLoop
	call WavyScreen_SetSCX_2
	ld a, [rLY]
	...
	jr nz, .next
	ld hl, WavyScreenLineOffsets_2 ; go back to the beginning if so
.next
	dec c
	jr nz, .loop
	xor a
...
WavyScreen_SetSCX_2:
	ld a, [rSTAT]
	and $3 ; is it H-blank?
	jr nz, WavyScreen_SetSCX_2 ; wait until it's H-blank
	ld a, [hl]
	ld [rSCX], a
	inc hl
	ld a, [hl]
...
.playerTurn
	...
	call CopySlowbroSpriteData_2
.next
	call CopyTempPicToMonPic_2
	jp AnimationShowMonPic_2

CopySlowbroSpriteData_2:
	ld bc, $0010
	ld a, BANK(SlowbroSprite)
	jp FarCopyData2

HideSubstituteShowMonAnim_2:
	ld a, [H_WHOSETURN]
	and a
...
; if the substitute broke, slide it down, else slide it offscreen horizontally
	...
	call AnimationSlideMonDown_2
	jr .next2
.substituteStillUp
	call AnimationSlideMonOff_2
.next2
	pop de
	pop hl
	pop bc
	...
	and a
	jp nz, LoadMiniSprite_2			; if it is, load mini sprite instead of mon pic
	ld a, [de]
...
.showMonPic
	ld a, [bc]
	and a
	jp nz, AnimationMinimizeMon_2
	call AnimationFlashMonPic_2
	jp AnimationShowMonPic_2

ReshowSubstituteAnim_2:
	ld hl, wPlayerBattleStatus2
	ld bc, wBattleMonHP
	ld a, [H_WHOSETURN]
	and a
...
.animate
	...
	call AnimationSlideMonOff_2
	call AnimationSubstitute_2
	jp AnimationShowMonPic_2

AnimationBoundUpAndDown_2:
...
AnimationBoundUpAndDownFast:
; Bounces the mon's sprite up and down several times. It is used
; by Splash's animation.
	ld c, 2
.loop
	push bc
	call AnimationSlideMonDownFast
	pop bc
	dec c
	jr nz, .loop
	jp AnimationShowMonPic_2
	
AnimationTransformMon_2:
; Redraws this mon's sprite as the back/front sprite of the opposing mon.
; Used in Transform.
	ret												; this function is not needed in this bank since Transform is in another bank
...
AnimationHideEnemyMonPic_2:
; Hides the enemy mon's sprite
	xor a
	ld [H_AUTOBGTRANSFERENABLED], a
	ld hl, AnimationHideMonPic_2
	call CallWithTurnFlipped_2
	ld a, $1
	ld [H_AUTOBGTRANSFERENABLED], a
	jp Delay3

InitMultipleObjectsOAM_2:
...
AnimationHideMonPic_2:
; Hides the mon's sprite.
	ld a, [H_WHOSETURN]
	and a
	jr z, .playerTurn
	ld a, 12
	jr ClearMonPicFromTileMap_2
.playerTurn
	ld a, 5 * SCREEN_WIDTH + 1

ClearMonPicFromTileMap_2:
	push hl
	push de
	push bc
	ld e, a
...
GetMonSpriteTileMapPointerFromRowCount_2:
	push de
	ld a, [H_WHOSETURN]
	and a
	jr nz, .enemyTurn
...
; c = number of columns
GetTileIDList_2:
	ld hl, TileIDListPointerTable_2
	ld e, a
	ld d, 0
	add hl, de
	add hl, de
...
.next
	ld [hBaseTileID], a
	jr CopyTileIDs_NoBGTransfer_2

; copy the tiles used when a mon is being sent out of or into a pokeball
CopyDownscaledMonTiles_2:
	call GetPredefRegisters
	ld a, [wDownscaledMonSize]
	and a
	jr nz, .smallerSize
	ld de, DownscaledMonTiles_5x5_2
	jr CopyTileIDs_NoBGTransfer_2
.smallerSize
	ld de, DownscaledMonTiles_3x3_2
; fall through

CopyTileIDs_NoBGTransfer_2:
	xor a
	ld [H_AUTOBGTRANSFERENABLED], a
; fall through
...
; in Razor Leaf's animation.
	...
	call AnimationFallingObjects_2
	pop af
	ld [rOBP0], a
	ret

AnimationPetalsFalling_2:
...
AnimationFallingObjects_2:
	ld c, a
	ld a, 1
	call InitMultipleObjectsOAM_2
	call FallingObjects_InitXCoords_2
	call FallingObjects_InitMovementData_2
	ld hl, wOAMBuffer
	ld [hl], 0
.loop
...
.innerLoop
	...
	call FallingObjects_UpdateMovementByte_2
	call FallingObjects_UpdateOAMEntry_2
	pop de
	ld hl, 4
	add hl, de
	ld e, l
...
FallingObjects_UpdateOAMEntry_2:
...
.next
	...
	ld a, [wFallingObjectMovementByte]
	ld b, a
	ld de, FallingObjects_DeltaXs_2
	and $7f
	add e
	jr nc, .noCarry
	inc d
...
FallingObjects_DeltaXs_2:
	db 0, 1, 3, 5, 7, 9, 11, 13, 15

FallingObjects_UpdateMovementByte_2:
	ld a, [wFallingObjectMovementByte]
	inc a
	ld b, a
	and $7f
...
FallingObjects_InitXCoords_2:
	ld hl, wOAMBuffer + $01
	ld de, FallingObjects_InitialXCoords_2
	ld a, [wNumFallingObjects]
	ld c, a
.loop
	ld a, [de]
...
FallingObjects_InitialXCoords_2:
	db $38,$40,$50,$60,$70,$88,$90,$56,$67,$4A,$77,$84,$98,$32,$22,$5C,$6C,$7D,$8E,$99

FallingObjects_InitMovementData_2:
	ld hl, wFallingObjectsMovementData
	ld de, FallingObjects_InitialMovementData_2
	ld a, [wNumFallingObjects]
	ld c, a
.loop
	ld a, [de]
...
FallingObjects_InitialMovementData_2:
	db $00,$84,$06,$81,$02,$88,$01,$83,$05,$89,$09,$80,$07,$87,$03,$82,$04,$85,$08,$86

AnimationShakeEnemyHUD_2:
...
; by SCX.
	call ShakeEnemyHUD_WritePlayerMonPicOAM_2
...
; Restore the original graphics.
	...
	ld hl, vBGMap1
	jp BattleAnimCopyTileMapToVRAM_2

; b = tile ID list index
; c = base tile ID
CopyTileIDsFromList_2:
	call GetPredefRegisters
	ld a, c
	ld [hBaseTileID], a
	ld a, b
...
CallHideSubstituteShowMonAnim__2:
	ld a, [H_WHOSETURN]
	and a
...
.main
	...
	call nz, HideSubstituteShowMonAnim_2
	ret

CallReshowSubstituteAnim__2:
	ld a, [H_WHOSETURN]
	and a
	ld a, [wPlayerBattleStatus2]
	jr z, .main
...
.main
	bit HAS_SUBSTITUTE_UP, a
	call nz, ReshowSubstituteAnim_2
	ret
