...
Route15GateLeftBinoculars:
	...
	ld bc, ARTICUNO							; to handle 2 bytes species ID
	ld a, b									; to handle 2 bytes species ID
	ld [wMonSpeciesTemp], a					; to handle 2 bytes species ID
	ld a, c									; to handle 2 bytes species ID
...
AerodactylFossil:
	ld bc, FOSSIL_AERODACTYL				; to handle 2 bytes species ID
	ld a, b									; to handle 2 bytes species ID
	ld [wMonSpeciesTemp], a					; to handle 2 bytes species ID
	ld a, c									; to handle 2 bytes species ID
	ld [wMonSpeciesTemp + 1], a				; to handle 2 bytes species ID
...
KabutopsFossil:
	ld bc, FOSSIL_KABUTOPS					; to handle 2 bytes species ID
	ld a, b									; to handle 2 bytes species ID
	ld [wMonSpeciesTemp], a					; to handle 2 bytes species ID
	ld a, c									; to handle 2 bytes species ID
	ld [wMonSpeciesTemp + 1], a				; to handle 2 bytes species ID
