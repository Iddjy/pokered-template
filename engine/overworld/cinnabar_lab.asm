GiveFossilToCinnabarLab:
	...
	ld bc, AERODACTYL			; to handle 2 bytes species IDs
	jr .fossilSelected
.choseHelixFossil
...
.choseDomeFossil
	...
	jr .fossilSelected
.choseSkullFossil
	ld bc, CRANIDOS				; to handle 2 bytes species IDs
	jr .fossilSelected
.choseArmorFossil
	ld bc, SHIELDON				; to handle 2 bytes species IDs
	jr .fossilSelected
.choseJawFossil
	ld bc, TYRUNT				; to handle 2 bytes species IDs
	jr .fossilSelected
.choseSailFossil
	ld bc, AMAURA				; to handle 2 bytes species IDs
.fossilSelected
	ld [wFossilItem], a
	ld a, b
	ld [wFossilMon], a
	ld a, c						; to handle 2 bytes species IDs
	ld [wFossilMon + 1], a		; to handle 2 bytes species IDs
...
LoadFossilItemAndMonName:
	...
	ld a, [wFossilMon + 1]			; to handle 2 bytes species IDs
