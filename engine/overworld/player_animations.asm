...
.dungeonWarpAnimation
	...
	call DelayFrames
	call PlayerSpinWhileMovingDown
	xor a								; needed to avoid waiting before playing the map music
	ld c, a								; because c is put in wAudioFadeOutControl inside PlayDefaultMusicCommon
	call PlayDefaultMusicCommon			; needed to restart the music after using a Secret Passage
	jr .done
.flyAnimation
	pop hl
	ld de, BirdSprite
