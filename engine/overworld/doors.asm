...
DoorTileIDPointers:
	...
	dbw INTERIOR,    InteriorDoorTileIDs	; for the Battle Facility
	dbw CAVERN,      CavernDoorTileIDs
	db $ff
...
FacilityDoorTileIDs:
	db $43,$58,$1b,$5C,$00	; added $5C because it's now a lift door

PlateauDoorTileIDs:
	db $3b,$1b,$00

; to make elevator and stairs tiles act as doors in this tileset too
InteriorDoorTileIDs:
	db $04, $15, $00

; for wall holes inside caverns
CavernDoorTileIDs:
	db $34, $00
