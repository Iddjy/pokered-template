...
.boxNotFull
	...
	ld [wMoveMonType], a
	call MoveMon
	jr nc, .depositAllowed
	ld hl, CantDepositLastNonFaintedMonText
	call PrintText
	jp BillsPCMenu
.depositAllowed
	call WaitForSoundToFinish
...
.next2
	...
	predef StatusScreen3				; add 3rd page with DVs/EVs
...
; added
CantDepositLastNonFaintedMonText
	TX_FAR _CantDepositLastNonFaintedMonText
	db "@"
