...
TextBoxFunctionTable:
	...
	dbw FORGET_REMEMBER_NOTHANKS_MENU, DoForgetRememberNoThanksMenu
	dbw STATS_MENU, DoSevenOptionsMenu
	dbw BUY_COINS_MENU, DoBuyCoinsMenu	; added
	db $ff ; terminator
...
TextBoxTextAndCoordTable:
	db STATS_MENU_TEMPLATE
	db 0,0,9,14 ; text box coordinates
	dw StatsNamesText
	...
	db BUY_COINS_MENU_TEMPLATE
	db 0,6,13,12
	dw BuyCoinsMenuText
	db 2,7

	db FORGET_REMEMBER_NOTHANKS_MENU_TEMPLATE
	db 0,0,11,6    ; text box coordinates
	dw ForgetRememberNoThanksText
	db 2,1   ; text coordinates
...
; add this to allow buying coins in bulks of 500
BuyCoinsMenuText:
	db		" 50:  ¥1000"
	next	"500: ¥10000"
	next	"CANCEL@"
...
DoBuyCoinsMenu:
	ld a, BUY_COINS_MENU_TEMPLATE
	ld d, 7											; wTopMenuItemY
	jr DoThreeOptionsMenu
DoBuySellQuitMenu:
	ld a, BUY_SELL_QUIT_MENU_TEMPLATE
	jr DoThreeOptionsMenuTop
DoForgetRememberNoThanksMenu:
	ld a, FORGET_REMEMBER_NOTHANKS_MENU_TEMPLATE
DoThreeOptionsMenuTop:
	ld d, 1											; wTopMenuItemY
DoThreeOptionsMenu:
	ld [wTextBoxID], a
	ld a, [wd730]
...
HandleMenu:
	...
	ld a, c
	ld [wMaxMenuItem], a
	ld a, d											; make wTopMenuItemY configurable
	ld [wTopMenuItemY], a
	ld a, $1
	ld [wTopMenuItemX], a
	xor a
...
GetMonFieldMoves:
	...
	ld a, [hld]
	ld [wMonSpeciesTemp + 1], a					; to handle signature moves later
	ld bc, wPartyMon1Moves - wPartyMon1Species
	add hl, bc
	ld d, h
	ld e, l
	ld c, NUM_MOVES + 1
...
.nextMove
	...
	jr z, .done
	inc de
	ld hl, FieldSignatureMoveDisplayData	; use a dedicated array for signature moves
	cp SIGNATURE_MOVE_1
...
.mapSignatureMove
	...
	push hl
	ld [wd11e], a
	callab MapSignatureMove					; get the mapped move id in case of signature move
	ld a, d
	pop hl
	pop de
	pop bc
...
FieldSignatureMoveDisplayData:
	db SOFTBOILED, $08, $08
	db $ff

; for Hyper Training
DoSevenOptionsMenu:
	ld a, STATS_MENU_TEMPLATE
	ld [wTextBoxID], a
	ld a, [wd730]
	set 6, a ; no printing delay
	ld [wd730], a
