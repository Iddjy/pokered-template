...
BlkPacket_TrainerCard:
	...
	ATTR_BLK_DATA %010, 1,1,0, 15,13, 15,13 ; Rainbow Badge		; reduced the affected region to avoid overlapping with 8th badge number
...
PalPacket_TrainerCard:    PAL_SET PAL_MEWMON, PAL_BADGE, PAL_BADGE2, PAL_YELLOWMON
