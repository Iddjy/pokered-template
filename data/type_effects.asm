...
; format: attacking type, defending type, damage multiplier
	...
	db GROUND,FLYING,DOES_NOT_AFFECT
	...
	db NORMAL,GHOST,DOES_NOT_AFFECT
	db GHOST,GHOST,SUPER_EFFECTIVE
	db FIRE,BUG,SUPER_EFFECTIVE
	db FIRE,ROCK,NOT_VERY_EFFECTIVE
	db WATER,GROUND,SUPER_EFFECTIVE
	db ELECTRIC,GROUND,DOES_NOT_AFFECT
	...
	db FIGHTING,GHOST,DOES_NOT_AFFECT
	...
	db GHOST,NORMAL,DOES_NOT_AFFECT
	...
	db POISON,STEEL,DOES_NOT_AFFECT
	db PSYCHIC,DARK,DOES_NOT_AFFECT
	db DRAGON,FAIRY,DOES_NOT_AFFECT
