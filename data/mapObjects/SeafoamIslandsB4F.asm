SeafoamIslandsB4F_Object:
	...
	warp 9, 1, 7, SEAFOAM_ISLANDS_B3F

	db 2 ; signs
	sign 9, 15, 5 ; SeafoamIslands5Text4
	sign 23, 1, 6 ; SeafoamIslands5Text5

	db 4 ; objects
	object SPRITE_BOULDER, 4, 15, STAY, NONE, 1 ; person
	object SPRITE_BOULDER, 5, 15, STAY, NONE, 2 ; person
	object SPRITE_BIRD, 6, 1, STAY, DOWN, 3, STATIC_MON, 50
	object SPRITE_BALL, 25, 16, STAY, NONE, 4, TM_58
	...
	warp_to 9, 1, SEAFOAM_ISLANDS_B4F_WIDTH
