VictoryRoad3F_Object:
	...
	db 10 ; objects
	object SPRITE_BLACK_HAIR_BOY_1, 28, 5, STAY, LEFT, 1, COOLTRAINER_M, 2
	object SPRITE_LASS, 7, 13, STAY, RIGHT, 2, COOLTRAINER_F, 2
	object SPRITE_BLACK_HAIR_BOY_1, 6, 14, STAY, LEFT, 3, COOLTRAINER_M, 3
	object SPRITE_LASS, 13, 3, STAY, RIGHT, 4, COOLTRAINER_F, 3
