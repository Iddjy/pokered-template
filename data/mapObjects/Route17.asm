Route17_Object:
	...
	db 10 ; objects
	object SPRITE_BIKER, 12, 19, STAY, LEFT, 1, CUE_BALL, 4
	object SPRITE_BIKER, 11, 16, STAY, RIGHT, 2, CUE_BALL, 5
	...
	object SPRITE_BIKER, 17, 58, STAY, LEFT, 6, CUE_BALL, 6
	object SPRITE_BIKER, 2, 68, STAY, RIGHT, 7, CUE_BALL, 7
	object SPRITE_BIKER, 14, 98, STAY, RIGHT, 8, CUE_BALL, 8
