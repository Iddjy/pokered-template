SaffronGym_Object:
	...
	object SPRITE_MEDIUM, 10, 1, STAY, DOWN, 2, CHANNELER, 14		; decreased by 8 since 8 unused trainers were removed
	object SPRITE_BUG_CATCHER, 17, 1, STAY, DOWN, 3, PSYCHIC_TR, 1
	object SPRITE_MEDIUM, 3, 7, STAY, DOWN, 4, CHANNELER, 15		; decreased by 8 since 8 unused trainers were removed
	object SPRITE_BUG_CATCHER, 17, 7, STAY, DOWN, 5, PSYCHIC_TR, 2
	object SPRITE_MEDIUM, 3, 13, STAY, DOWN, 6, CHANNELER, 16		; decreased by 8 since 8 unused trainers were removed
	object SPRITE_BUG_CATCHER, 17, 13, STAY, DOWN, 7, PSYCHIC_TR, 3
