Route24_Object:
	...
	object SPRITE_BLACK_HAIR_BOY_1, 5, 20, STAY, UP, 2, JR_TRAINER_M, 2
	object SPRITE_BLACK_HAIR_BOY_1, 11, 19, STAY, LEFT, 3, JR_TRAINER_M, 3
	...
	object SPRITE_BUG_CATCHER, 11, 31, STAY, LEFT, 7, BUG_CATCHER, 9
