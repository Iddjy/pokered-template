Route6_Object:
	...
	db 1 ; signs
	sign 19, 15, 8 ; Route6Text7

	db 7 ; objects
	object SPRITE_BLACK_HAIR_BOY_1, 10, 21, STAY, RIGHT, 1, JR_TRAINER_M, 4
	object SPRITE_LASS, 11, 21, STAY, LEFT, 2, JR_TRAINER_F, 2
	...
	object SPRITE_BALL, 6, 4, STAY, NONE, 7, TM_86
