Route11_Object:
	...
	db 1 ; signs
	sign 1, 5, 12 ; Route11Text11 updated index because there is one more object
	...
	object SPRITE_BLACK_HAIR_BOY_2, 36, 11, STAY, DOWN, 4, ENGINEER, 1	; decreased by one since one unused trainer was removed
	...
	object SPRITE_BLACK_HAIR_BOY_2, 45, 16, STAY, LEFT, 9, ENGINEER, 2	; decreased by one since one unused trainer was removed
	object SPRITE_BUG_CATCHER, 22, 12, STAY, UP, 10, YOUNGSTER, 12
	object SPRITE_BALL, 55, 0, STAY, NONE, 11, TM_40
