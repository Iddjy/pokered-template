SSAnne2FRooms_Object:
	...
	object SPRITE_FISHER2, 13, 4, STAY, LEFT, 2, FISHER, 1
	object SPRITE_GENTLEMAN, 0, 14, STAY, RIGHT, 3, GENTLEMAN, 4	; decreased by one since one unused trainer was removed
