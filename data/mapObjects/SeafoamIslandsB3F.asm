SeafoamIslandsB3F_Object:
	...
	warp 10, 2, 4, SEAFOAM_ISLANDS_B4F
	warp 14, 0, 0, SEAFOAM_ISLANDS_B4F
	warp 15, 0, 1, SEAFOAM_ISLANDS_B4F
	...
	object SPRITE_BALL, 12,  2, STAY, NONE, 7, TM_14
	object SPRITE_BOULDER, 11, 3, STAY, BOULDER_MOVEMENT_BYTE_2, 8
	...
	warp_to 10, 2, SEAFOAM_ISLANDS_B3F_WIDTH
