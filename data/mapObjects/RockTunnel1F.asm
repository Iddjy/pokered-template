RockTunnel1F_Object:
	...
	db 1 ; signs
	sign 11, 29, 11 ; RockTunnel1Text8
	...
	object SPRITE_LASS, 37, 21, STAY, LEFT, 5, JR_TRAINER_F, 16				; decreased by one since one unused trainer was removed
	object SPRITE_LASS, 22, 24, STAY, DOWN, 6, JR_TRAINER_F, 17				; decreased by one since one unused trainer was removed
	object SPRITE_LASS, 32, 24, STAY, RIGHT, 7, JR_TRAINER_F, 18			; decreased by one since one unused trainer was removed
	object SPRITE_BALL, 21, 21, STAY, NONE, 8, TM_61
	object SPRITE_BOULDER, 20, 19, STAY, BOULDER_MOVEMENT_BYTE_2, 9
	object SPRITE_BOULDER, 21, 19, STAY, BOULDER_MOVEMENT_BYTE_2, 10
