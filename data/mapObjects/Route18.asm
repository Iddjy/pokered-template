Route18_Object:
	...
	db 3 ; objects
	object SPRITE_BLACK_HAIR_BOY_1, 36, 11, STAY, RIGHT, 1, BIRD_KEEPER, 8
	object SPRITE_BLACK_HAIR_BOY_1, 40, 15, STAY, LEFT, 2, BIRD_KEEPER, 9
	object SPRITE_BLACK_HAIR_BOY_1, 42, 13, STAY, LEFT, 3, BIRD_KEEPER, 10
