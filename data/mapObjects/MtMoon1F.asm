MtMoon1F_Object:
	...
	object SPRITE_BLACK_HAIR_BOY_2, 24, 31, STAY, UP, 4, SUPER_NERD, 1
	object SPRITE_LASS, 16, 23, STAY, DOWN, 5, LASS, 6
	object SPRITE_BUG_CATCHER, 7, 22, STAY, DOWN, 6, BUG_CATCHER, 7
	object SPRITE_BUG_CATCHER, 30, 27, STAY, RIGHT, 7, BUG_CATCHER, 8
	...
	object SPRITE_BALL, 5, 32, STAY, NONE, 13, TM_34
