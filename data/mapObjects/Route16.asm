Route16_Object:
	...
	db 2 ; signs
	sign 27, 11, 10 ; Route16Text8
	sign 5, 17, 11 ; Route16Text9

	db 9 ; objects
	object SPRITE_BIKER, 17, 12, STAY, LEFT, 1, BIKER, 5
	object SPRITE_BIKER, 14, 13, STAY, RIGHT, 2, CUE_BALL, 1
	object SPRITE_BIKER, 11, 12, STAY, UP, 3, CUE_BALL, 2
	object SPRITE_BIKER, 9, 11, STAY, LEFT, 4, BIKER, 6
	object SPRITE_BIKER, 6, 10, STAY, RIGHT, 5, CUE_BALL, 3
	object SPRITE_BIKER, 3, 12, STAY, RIGHT, 6, BIKER, 7
	object SPRITE_SNORLAX, 26, 10, STAY, DOWN, 7 ; person
	object SPRITE_BALL, 1, 5, STAY, NONE, 8, TM_04
	object SPRITE_BALL, 23, 15, STAY, NONE, 9, TM_75
