VictoryRoad1F_Object:
	...
	db 7 ; objects
	object SPRITE_LASS, 7, 5, STAY, RIGHT, 1, COOLTRAINER_F, 4				; decreased by one since one unused trainer was removed
	object SPRITE_BLACK_HAIR_BOY_1, 3, 2, STAY, DOWN, 2, COOLTRAINER_M, 4	; decreased by one since one unused trainer was removed
