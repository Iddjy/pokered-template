ExternalMapEntries:
	...
	EMAP $8,$5,Route7Name
	EMAP $D,$5,Route8Name
	EMAP $C,$2,Route9Name	; moved it one spot to the left
	EMAP $E,$2,Route10Name	; moved it two spots up
