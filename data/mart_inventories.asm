...
BerryHouseText1::
	TX_MART POMEG_BERRY, KELPSY_BERRY, QUALOT_BERRY, HONDEW_BERRY, GREPA_BERRY, TAMATO_BERRY
...
CeladonMart2Clerk2Text::
	TX_PRIZE_VENDOR				; use Game Corner Prizes type of menu for TMs Shop

; Celadon Dept. Store 4F
CeladonMart4ClerkText::
	TX_MART POKE_DOLL, FIRE_STONE, THUNDER_STONE, WATER_STONE, LEAF_STONE, ICE_STONE, SUN_STONE, SHINY_STONE, DAWN_STONE, DUSK_STONE

; Celadon Dept. Store 5F (1)
CeladonMart5Clerk1Text::
	TX_MART GUARD_SPEC, DIRE_HIT, X_ATTACK, X_DEFEND, X_SPEED, X_SP.ATK, X_SP.DEF, X_ACCURACY

; Celadon Dept. Store 5F (2)
CeladonMart5Clerk2Text::
	TX_MART HP_UP, PROTEIN, IRON, CARBOS, CALCIUM, ZINC
...
; add a TM Shop in Cinnabar Lab
CinnabarLabTMSalesmanText::
	TX_PRIZE_VENDOR
