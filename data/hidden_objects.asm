HiddenObjectMaps:
	...
	db CERULEAN_CITY
	db ROUTE_4
	db DAYCARE								; for adding a PC in the Daycare
	db SILPH_CO_1F							; for adding a PC next to the Battle Facility, as well as a text for the Battle Facility Elevator
	db $FF
...
Route4HiddenObjects:
	...
	dbw BANK(HiddenItems),HiddenItems
	db $FF
DayCareHiddenObjects:					; add a PC in the Daycare
	db $01,$00,$04
	db BANK(OpenPokemonCenterPC)
	dw OpenPokemonCenterPC
	db $FF
SilphCo1FHiddenObjects:					; add a PC next to Battle Facility and a text for the blocked Elevator
	db $00,$07,$04
	db BANK(OpenPokemonCenterPC)
	dw OpenPokemonCenterPC
	db $00,$08,$04
	db BANK(PrintElevatorCantBeCalledText)
	dw PrintElevatorCantBeCalledText
	db $FF
