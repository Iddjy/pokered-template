WildDataPointers:
	...
	dw NoMons
	dw NoMons
	dw NoMons		; Battle Facility
	dw NoMons		; Battle Facility Elevator
	dw $FFFF
...
INCLUDE "data/wildPokemon/route19.asm"			; use dedicated encounter table instead of shared one with route 20
INCLUDE "data/wildPokemon/route20.asm"			; use dedicated encounter table instead of shared one with route 19
