const_value = 0
	...
	const EVENT_GOT_TM07                             ; 050, (D751, bit 0)
	...
	const EVENT_MADE_DONATION_1                      ; 06A, (D754, bit 2)
	const EVENT_MADE_DONATION_2                      ; 06B, (D754, bit 3)
	const EVENT_MADE_DONATION_3                      ; 06C, (D754, bit 4)
	const EVENT_PENDING_GIFT_CARD                    ; 06D, (D754, bit 5)
	const EVENT_GOT_ODD_KEYSTONE                     ; 06E, (D754, bit 6)
	...
	const EVENT_GOT_TM84                             ; 076, (D755, bit 6)
	...
	const EVENT_GOT_TM67                             ; 118, (D76A, bit 0)
	...
	const EVENT_GOT_TM64                             ; 166, (D773, bit 6)
	...
	const EVENT_GOT_TM82                             ; 180, (D777, bit 0)
	...
	const EVENT_GOT_TM56                             ; 18C, (D778, bit 4)
	...
	const EVENT_GOT_TM93                             ; 1A8, (D77C, bit 0)
	...
	const EVENT_GOT_TM05                             ; 1BD, (D77E, bit 5)
	const EVENT_GOT_TM23                             ; 1BE, (D77E, bit 6)
	const EVENT_GOT_TM50                             ; 1BF, (D77E, bit 7)
	...
	const EVENT_TALKED_TO_ERIK                       ; 240, (D78F, bit 0)
	const EVENT_TALKED_TO_SARA                       ; 241, (D78F, bit 1)
	const EVENT_GOT_TM57                             ; 242, (D78F, bit 2)
	const EVENT_GOT_TM87                             ; 243, (D78F, bit 3)
	...
	const EVENT_ROUTE21_GRASS_PATCH_CUT              ; 268, (D794, bit 0)
	...
	const EVENT_GOT_TM36                             ; 298, (D79A, bit 0)
	...
	const EVENT_RESURRECTED_OLD_AMBER                ; 2E8, (D7A4, bit 0)
	const EVENT_GOT_TM74                             ; 2E9, (D7A4, bit 1)
	...
	const EVENT_GOT_TM60                             ; 360, (D7B3, bit 0)
	...
	const EVENT_GOT_TM59                             ; 6FF, (D826, bit 7)
	...
	const EVENT_SILPH_CO_ALTERNATE_MUSIC             ; 78E, (D838, bit 6) use this flag to trigger alternate music in Silph Co once Team Rocket is defeated
	...
	const EVENT_GOT_ORIGIN_PLATE                     ; 8C8, (D860, bit 0)
	const EVENT_BATTLE_FACILITY_INTRO_TEXT           ; 8C9, (D860, bit 1)
	const EVENT_GOT_BATTLE_PASS                      ; 8CA, (D860, bit 2)
	const EVENT_GOT_GRISEOUS_CORE                    ; 8CB, (D860, bit 3)
	const EVENT_8CC                                  ; 8CC, (D860, bit 4)
	const EVENT_MOVE_TUTOR_INTRO_TEXT                ; 8CD, (D860, bit 5)
	...
	const EVENT_BEAT_BROCK_REMATCH                   ; 908, (D868, bit 0)
	const EVENT_BEAT_MISTY_REMATCH                   ; 909, (D868, bit 1)
	const EVENT_BEAT_LT_SURGE_REMATCH                ; 90A, (D868, bit 2)
	const EVENT_BEAT_ERIKA_REMATCH                   ; 90B, (D868, bit 3)
	const EVENT_BEAT_KOGA_REMATCH                    ; 90C, (D868, bit 4)
	const EVENT_BEAT_SABRINA_REMATCH                 ; 90D, (D868, bit 5)
	const EVENT_BEAT_BLAINE_REMATCH                  ; 90E, (D868, bit 6)
	const EVENT_BEAT_GIOVANNI_REMATCH                ; 90F, (D868, bit 7)
	...
	const EVENT_TM_MART_1_BOUGHT_TM1                 ; 920, (D86B, bit 0) for the first TMs shop (needs to be at bit 0 of a byte)
	const EVENT_TM_MART_1_BOUGHT_TM2                 ; 921, (D86B, bit 1) all these flags must follow each other
	const EVENT_TM_MART_1_BOUGHT_TM3                 ; 922, (D86B, bit 2) for the TMs shop
	const EVENT_TM_MART_1_BOUGHT_TM4                 ; 923, (D86B, bit 3) for the TMs shop
	const EVENT_TM_MART_1_BOUGHT_TM5                 ; 924, (D86B, bit 4) for the TMs shop
	const EVENT_TM_MART_1_BOUGHT_TM6                 ; 925, (D86B, bit 5) for the TMs shop
	const EVENT_TM_MART_1_BOUGHT_TM7                 ; 926, (D86B, bit 6) for the TMs shop
	const EVENT_TM_MART_1_BOUGHT_TM8                 ; 927, (D86B, bit 7) for the TMs shop
	const EVENT_TM_MART_1_BOUGHT_TM9                 ; 928, (D86C, bit 0) for the TMs shop
	const EVENT_TM_MART_1_BOUGHT_TM10                ; 929, (D86C, bit 1) for the TMs shop
	...
	const EVENT_TM_MART_2_BOUGHT_TM1                 ; 930, (D86D, bit 0) for the second TMs shop (needs to be at bit 0 of a byte)
	const EVENT_TM_MART_2_BOUGHT_TM2                 ; 931, (D86D, bit 1) all these flags must follow each other
	const EVENT_TM_MART_2_BOUGHT_TM3                 ; 932, (D86D, bit 2) for the second TMs shop
	const EVENT_TM_MART_2_BOUGHT_TM4                 ; 933, (D86D, bit 3) for the second TMs shop
	const EVENT_TM_MART_2_BOUGHT_TM5                 ; 934, (D86D, bit 4) for the second TMs shop
	const EVENT_TM_MART_2_BOUGHT_TM6                 ; 935, (D86D, bit 5) for the second TMs shop
	const EVENT_TM_MART_2_BOUGHT_TM7                 ; 936, (D86D, bit 6) for the second TMs shop
	const EVENT_TM_MART_2_BOUGHT_TM8                 ; 937, (D86D, bit 7) for the second TMs shop
	const EVENT_TM_MART_2_BOUGHT_TM9                 ; 938, (D86E, bit 0) for the second TMs shop
	const EVENT_TM_MART_2_BOUGHT_TM10                ; 939, (D86E, bit 1) for the second TMs shop
	...
	const EVENT_CAUGHT_ARTICUNO                      ; 96A, (D874, bit 2)
	const EVENT_CAUGHT_ZAPDOS                        ; 96B, (D874, bit 3)
	const EVENT_CAUGHT_MOLTRES                       ; 96C, (D874, bit 4)
	const EVENT_CAUGHT_MEWTWO                        ; 96D, (D874, bit 5)
