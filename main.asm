...
INCLUDE "engine/menu/items_menu.asm"

INCLUDE "engine/pc_service.asm"

INCLUDE "engine/menu/tm_shop.asm"

INCLUDE "engine/items/get_item_price.asm"

INCLUDE "engine/menu/battle_facility_shop.asm"

INCLUDE "data/battle_facility_shop.asm"

INCLUDE "engine/overworld/alternate_musics.asm"
...
INCLUDE "engine/battle/print_ghost_text.asm"
INCLUDE "engine/pokedex.asm"
INCLUDE "engine/base_stats.asm"	; moved from bank 31
INCLUDE "engine/evolution.asm"	; moved from bank 1D
...
INCLUDE "engine/battle/print_type.asm"						; moved from bank 9 so that it's in the same bank as conversion effect
INCLUDE "engine/battle/save_trainer_name.asm"				; moved from bank 9
...
; added
INCLUDE "data/mapHeaders/BattleFacility.asm"
INCLUDE "scripts/BattleFacility.asm"
INCLUDE "data/mapObjects/BattleFacility.asm"
BattleFacility_Blocks: INCBIN "maps/BattleFacility.blk"

; added
INCLUDE "data/mapHeaders/BattleFacilityElevator.asm"
INCLUDE "scripts/BattleFacilityElevator.asm"
INCLUDE "data/mapObjects/BattleFacilityElevator.asm"
BattleFacilityElevator_Blocks: INCBIN "maps/BattleFacilityElevator.blk"

INCLUDE "data/mapHeaders/BerryHouse.asm"
INCLUDE "scripts/BerryHouse.asm"
INCLUDE "data/mapObjects/BerryHouse.asm"
BerryHouse_Blocks: INCBIN "maps/BerryHouse.blk"

INCLUDE "engine/overworld/npc_movement.asm"
INCLUDE "engine/overworld/doors.asm"
INCLUDE "engine/overworld/ledges.asm"
INCLUDE "engine/overworld/elevator.asm"			; moved from bank 1E

INCLUDE "text/item_names.asm"					; moved from bank 1

INCLUDE "engine/battle/mirror_move.asm"
INCLUDE "engine/battle/moveEffects/freeze_burn_paralyze_side_effects.asm"	; moved from bank F
INCLUDE "engine/battle/moveEffects/burn_effect.asm"							; for Will-O-Wisp
INCLUDE "engine/battle/moveEffects/heal_effect.asm"							; moved from bank E
INCLUDE "engine/battle/moveEffects/transform_effect.asm"					; moved from bank E
INCLUDE "engine/battle/moveEffects/reflect_light_screen_effect.asm"			; moved from bank E
INCLUDE "engine/battle/bide.asm"											; moved from bank F
INCLUDE "engine/battle/between_turns_events.asm"							; moved from bank F
INCLUDE "engine/battle/critical_hit_test.asm"								; moved from bank F
INCLUDE "engine/battle/moveEffects/switch_effect.asm"
INCLUDE "engine/battle/moveEffects/hyper_beam_effect.asm"					; moved from bank E
INCLUDE "engine/battle/moveEffects/rage_effect.asm"							; moved from bank E
INCLUDE "engine/battle/moveEffects/substitute_effect.asm"					; moved from bank F
INCLUDE "engine/battle/animate_retreating_player_mon.asm"					; moved from bank F
INCLUDE "engine/battle/randomize_damage.asm"								; moved from bank F
INCLUDE "engine/battle/wild_battle_item_drops.asm"
...
INCLUDE "engine/menu/status_screen3.asm"
...
INCLUDE "engine/battle/moveEffects/mist_effect.asm"					; moved from bank C to make room for new pictures
INCLUDE "engine/battle/check_cotton_spore.asm"
...
SpiritombPicFront::   INCBIN "pic/bmon/spiritomb.pic"
SpiritombPicBack::    INCBIN "pic/monback/spiritombb.pic"
...
INCLUDE "engine/battle/moveEffects/two_to_five_attacks_effect.asm"	; moved from bank F
INCLUDE "engine/battle/moveEffects/pay_day_effect.asm"				; moved from bank B


SECTION "bankE", ROMX

INCLUDE "data/moves.asm"
INCLUDE "data/signature_moves.asm"
INCLUDE "data/cries.asm"
INCLUDE "data/catch_rates.asm"
INCLUDE "data/mon_pics_banks.asm"
INCLUDE "engine/battle/scroll_draw_trainer_pic.asm"
INCLUDE "engine/battle/trainer_ai.asm"
INCLUDE "engine/battle/pp_management.asm"				; moved this from bank 1A and bank F
INCLUDE "engine/battle/draw_hud_pokeball_gfx.asm"
INCLUDE "engine/battle/pokeball_icon.asm"
INCLUDE "engine/battle/signature_moves.asm"

INCLUDE "data/mapHeaders/Daycare.asm"					; moved from bank $15
INCLUDE "scripts/Daycare.asm"							; moved from bank $15
INCLUDE "data/mapObjects/Daycare.asm"					; moved from bank $15

Daycare_Blocks: INCBIN "maps/Daycare.blk"				; moved from bank $15

INCLUDE "data/daycare_groups.asm"
INCLUDE "data/daycare_moves.asm"
...
INCLUDE "engine/pokedex_rating.asm"											; moved from bank 11 to use CountSetBits_16bits
INCLUDE "engine/battle/moveEffects/move_attributes_modification_effect.asm"	; for moves whose attributes (like BP or type) are dynamic
...
RedPicBack::           INCBIN "pic/trainer/redb.pic"	; Both these pics need to be in the same bank
OldManPic::            INCBIN "pic/trainer/oldman.pic"	; Both these pics need to be in the same bank
OldManPicEnd::

TrainerInfoTextBoxTileGraphics:  INCBIN "gfx/trainer_info.2bpp"			; moved from bank B
TrainerInfoTextBoxTileGraphicsEnd:										; moved from bank B
BlankLeaderNames:                INCBIN "gfx/blank_leader_names.2bpp"	; moved from bank B
CircleTile:                      INCBIN "gfx/circle_tile.2bpp"			; moved from bank B
BadgeNumbersTileGraphics:        INCBIN "gfx/badge_numbers.2bpp"		; moved from bank B
...
INCLUDE "engine/tm_shop.asm"
INCLUDE "engine/slot_machine.asm"					; moved from bank $0D
INCLUDE "engine/game_corner_slots.asm"				; moved from bank $0D
...
INCBIN "maps/Route12SuperRodHouse.blk"		; use the actual map that was supposed to be used, since now the Daycare map is different from this one
...
INCLUDE "engine/overworld/wild_mons.asm"	; moved from bank 3
...
TradingAnimationGraphics:		; moved from bank $0E
INCBIN "gfx/game_boy.2bpp"		; moved from bank $0E
INCBIN "gfx/link_cable.2bpp"	; moved from bank $0E
TradingAnimationGraphicsEnd:	; moved from bank $0E

; Pokeball traveling through the link cable.
TradingAnimationGraphics2: INCBIN "gfx/trade2.2bpp"		; moved from bank $0E
TradingAnimationGraphics2End:							; moved from bank $0E
...
; add this map for Hyper Training
INCLUDE "data/mapHeaders/Route23HyperTrainingRoom.asm"
INCLUDE "scripts/Route23HyperTrainingRoom.asm"
INCLUDE "data/mapObjects/Route23HyperTrainingRoom.asm"
Route23HyperTrainingRoom_Blocks: INCBIN "maps/Route23HyperTrainingRoom.blk"

INCLUDE "engine/predefs17_2.asm"

INCLUDE "engine/hidden_object_functions17.asm"

INCLUDE "engine/battle_facility.asm"
...
INCLUDE "engine/battle/paddingBank1A.asm"				; deleted the original decrementPP function, left empty space
														; in its place so that the gfx below remain at the same offset
														; (the game's graphics break if they are moved)
														; this empty space might be used for something later
...
INCLUDE "data/trainer_palettes.asm"		; pointers for trainer palettes
...
INCLUDE "data/mapHeaders/LancesRoom.asm"			; moved from bank $16
INCLUDE "scripts/LancesRoom.asm"					; moved from bank $16
INCLUDE "data/mapObjects/LancesRoom.asm"			; moved from bank $16
LancesRoom_Blocks: INCBIN "maps/LancesRoom.blk"		; moved from bank $16

INCLUDE "engine/menu/league_pc.asm"

INCLUDE "engine/overworld/hidden_items.asm"

INCLUDE "engine/e4_rematch.asm"

INCLUDE "engine/gamefreak.asm"	; moved from bank $1C
...
SECTION "bank2D", ROMX					; added this so that learnsets have a whole bank to themselves

INCLUDE "engine/evos_moves.asm"			; moved from Bank E 


SECTION "bank2E", ROMX					; added this so that trainer parties have a whole bank to themselves

INCLUDE "engine/battle/read_trainer_party.asm"
INCLUDE "data/trainer_parties.asm"

INCLUDE "engine/battle/battle_facility.asm"


SECTION "bank2F", ROMX					; added this so that new move effects have a whole bank to themselves

INCLUDE "engine/battle/additional_move_effects.asm"
INCLUDE "engine/battle/moveEffects/focus_energy_effect.asm"	; moved from bank 9
INCLUDE "engine/battle/moveEffects/explode_effect.asm"		; moved from bank F
INCLUDE "engine/battle/defrost.asm"							; moved from bank F
INCLUDE "engine/battle/moveEffects/additional_effects.asm"	; moved from bank F
INCLUDE "engine/battle/moveEffects/metronome_effect.asm"	; moved from bank F
INCLUDE "engine/battle/move_hit_test.asm"					; moved from bank F


SECTION "bank30", ROMX					; added new animations in a dedicated bank

INCLUDE "engine/battle/animations2.asm"

INCLUDE "data/animations2.asm"


SECTION "bank31", ROMX					; moved base stats to a dedicated bank to make room for new pokemon

BaseStats: INCLUDE "data/base_stats.asm"


SECTION "Pics 6", ROMX	; bank $33
...
YanmegaPicFront::     INCBIN "pic/bmon/yanmega.pic"
YanmegaPicBack::      INCBIN "pic/monback/yanmegab.pic"
...
MismagiusPicBack::    INCBIN "pic/monback/mismagiusb.pic"
GirafarigPicFront::   INCBIN "pic/bmon/girafarig.pic"
GirafarigPicBack::    INCBIN "pic/monback/girafarigb.pic"
FarigirafPicFront::   INCBIN "pic/bmon/farigiraf.pic"
FarigirafPicBack::    INCBIN "pic/monback/farigirafb.pic"
GligarPicFront::      INCBIN "pic/bmon/gligar.pic"
GligarPicBack::       INCBIN "pic/monback/gligarb.pic"
GliscorPicFront::     INCBIN "pic/bmon/gliscor.pic"
GliscorPicBack::      INCBIN "pic/monback/gliscorb.pic"
...
UrsalunaPicFront::    INCBIN "pic/bmon/ursaluna.pic"
UrsalunaPicBack::     INCBIN "pic/monback/ursalunab.pic"
...
MamoswinePicFront::   INCBIN "pic/bmon/mamoswine.pic"
MamoswinePicBack::    INCBIN "pic/monback/mamoswineb.pic"
...
WingullPicFront::     INCBIN "pic/bmon/wingull.pic"
WingullPicBack::      INCBIN "pic/monback/wingullb.pic"
PelipperPicFront::    INCBIN "pic/bmon/pelipper.pic"
PelipperPicBack::     INCBIN "pic/monback/pelipperb.pic"
...
GalladePicFront::     INCBIN "pic/bmon/gallade.pic"
GalladePicBack::      INCBIN "pic/monback/galladeb.pic"
ShroomishPicFront::   INCBIN "pic/bmon/shroomish.pic"
ShroomishPicBack::    INCBIN "pic/monback/shroomishb.pic"
BreloomPicFront::     INCBIN "pic/bmon/breloom.pic"
BreloomPicBack::      INCBIN "pic/monback/breloomb.pic"
WhismurPicFront::     INCBIN "pic/bmon/whismur.pic"
WhismurPicBack::      INCBIN "pic/monback/whismurb.pic"
LoudredPicFront::     INCBIN "pic/bmon/loudred.pic"
LoudredPicBack::      INCBIN "pic/monback/loudredb.pic"
ExploudPicFront::     INCBIN "pic/bmon/exploud.pic"
ExploudPicBack::      INCBIN "pic/monback/exploudb.pic"
MakuhitaPicFront::    INCBIN "pic/bmon/makuhita.pic"
MakuhitaPicBack::     INCBIN "pic/monback/makuhitab.pic"
HariyamaPicFront::    INCBIN "pic/bmon/hariyama.pic"
HariyamaPicBack::     INCBIN "pic/monback/hariyamab.pic"


SECTION "Pics 8", ROMX	; bank $35

AronPicFront::        INCBIN "pic/bmon/aron.pic"
AronPicBack::         INCBIN "pic/monback/aronb.pic"
LaironPicFront::      INCBIN "pic/bmon/lairon.pic"
LaironPicBack::       INCBIN "pic/monback/laironb.pic"
AggronPicFront::      INCBIN "pic/bmon/aggron.pic"
AggronPicBack::       INCBIN "pic/monback/aggronb.pic"
MedititePicFront::    INCBIN "pic/bmon/meditite.pic"
MedititePicBack::     INCBIN "pic/monback/medititeb.pic"
MedichamPicFront::    INCBIN "pic/bmon/medicham.pic"
MedichamPicBack::     INCBIN "pic/monback/medichamb.pic"
...
ShuppetPicFront::     INCBIN "pic/bmon/shuppet.pic"
ShuppetPicBack::      INCBIN "pic/monback/shuppetb.pic"
BanettePicFront::     INCBIN "pic/bmon/banette.pic"
BanettePicBack::      INCBIN "pic/monback/banetteb.pic"
DuskullPicFront::     INCBIN "pic/bmon/duskull.pic"
DuskullPicBack::      INCBIN "pic/monback/duskullb.pic"
DusclopsPicFront::    INCBIN "pic/bmon/dusclops.pic"
DusclopsPicBack::     INCBIN "pic/monback/dusclopsb.pic"
DusknoirPicFront::    INCBIN "pic/bmon/dusknoir.pic"
DusknoirPicBack::     INCBIN "pic/monback/dusknoirb.pic"
AbsolPicFront::       INCBIN "pic/bmon/absol.pic"
AbsolPicBack::        INCBIN "pic/monback/absolb.pic"
SnoruntPicFront::     INCBIN "pic/bmon/snorunt.pic"
SnoruntPicBack::      INCBIN "pic/monback/snoruntb.pic"
GlaliePicFront::      INCBIN "pic/bmon/glalie.pic"
GlaliePicBack::       INCBIN "pic/monback/glalieb.pic"
FroslassPicFront::    INCBIN "pic/bmon/froslass.pic"
FroslassPicBack::     INCBIN "pic/monback/froslassb.pic"
SphealPicFront::      INCBIN "pic/bmon/spheal.pic"
SphealPicBack::       INCBIN "pic/monback/sphealb.pic"
SealeoPicFront::      INCBIN "pic/bmon/sealeo.pic"
SealeoPicBack::       INCBIN "pic/monback/sealeob.pic"
WalreinPicFront::     INCBIN "pic/bmon/walrein.pic"
WalreinPicBack::      INCBIN "pic/monback/walreinb.pic"
TurtwigPicFront::     INCBIN "pic/bmon/turtwig.pic"
TurtwigPicBack::      INCBIN "pic/monback/turtwigb.pic"
GrotlePicFront::      INCBIN "pic/bmon/grotle.pic"
GrotlePicBack::       INCBIN "pic/monback/grotleb.pic"
TorterraPicFront::    INCBIN "pic/bmon/torterra.pic"
TorterraPicBack::     INCBIN "pic/monback/torterrab.pic"
ChimcharPicFront::    INCBIN "pic/bmon/chimchar.pic"
ChimcharPicBack::     INCBIN "pic/monback/chimcharb.pic"
MonfernoPicFront::    INCBIN "pic/bmon/monferno.pic"
MonfernoPicBack::     INCBIN "pic/monback/monfernob.pic"
InfernapePicFront::   INCBIN "pic/bmon/infernape.pic"
InfernapePicBack::    INCBIN "pic/monback/infernapeb.pic"
StarlyPicFront::      INCBIN "pic/bmon/starly.pic"
StarlyPicBack::       INCBIN "pic/monback/starlyb.pic"
StaraviaPicFront::    INCBIN "pic/bmon/staravia.pic"
StaraviaPicBack::     INCBIN "pic/monback/staraviab.pic"
StaraptorPicFront::   INCBIN "pic/bmon/staraptor.pic"
StaraptorPicBack::    INCBIN "pic/monback/staraptorb.pic"
ShinxPicFront::       INCBIN "pic/bmon/shinx.pic"
ShinxPicBack::        INCBIN "pic/monback/shinxb.pic"


SECTION "Pics 9", ROMX	; bank $36

LuxioPicFront::       INCBIN "pic/bmon/luxio.pic"
LuxioPicBack::        INCBIN "pic/monback/luxiob.pic"
LuxrayPicFront::      INCBIN "pic/bmon/luxray.pic"
LuxrayPicBack::       INCBIN "pic/monback/luxrayb.pic"
BudewPicFront::       INCBIN "pic/bmon/budew.pic"
BudewPicBack::        INCBIN "pic/monback/budewb.pic"
RoseliaPicFront::     INCBIN "pic/bmon/roselia.pic"
RoseliaPicBack::      INCBIN "pic/monback/roseliab.pic"
RoseradePicFront::    INCBIN "pic/bmon/roserade.pic"
RoseradePicBack::     INCBIN "pic/monback/roseradeb.pic"
BuizelPicFront::      INCBIN "pic/bmon/buizel.pic"
BuizelPicBack::       INCBIN "pic/monback/buizelb.pic"
FloatzelPicFront::    INCBIN "pic/bmon/floatzel.pic"
FloatzelPicBack::     INCBIN "pic/monback/floatzelb.pic"
DrifloonPicFront::    INCBIN "pic/bmon/drifloon.pic"
DrifloonPicBack::     INCBIN "pic/monback/drifloonb.pic"
DrifblimPicFront::    INCBIN "pic/bmon/drifblim.pic"
DrifblimPicBack::     INCBIN "pic/monback/drifblimb.pic"
BronzorPicFront::     INCBIN "pic/bmon/bronzor.pic"
BronzorPicBack::      INCBIN "pic/monback/bronzorb.pic"
BronzongPicFront::    INCBIN "pic/bmon/bronzong.pic"
BronzongPicBack::     INCBIN "pic/monback/bronzongb.pic"
RioluPicFront::       INCBIN "pic/bmon/riolu.pic"
RioluPicBack::        INCBIN "pic/monback/riolub.pic"
LucarioPicFront::     INCBIN "pic/bmon/lucario.pic"
LucarioPicBack::      INCBIN "pic/monback/lucariob.pic"
SkorupiPicFront::     INCBIN "pic/bmon/skorupi.pic"
SkorupiPicBack::      INCBIN "pic/monback/skorupib.pic"
DrapionPicFront::     INCBIN "pic/bmon/drapion.pic"
DrapionPicBack::      INCBIN "pic/monback/drapionb.pic"
CroagunkPicFront::    INCBIN "pic/bmon/croagunk.pic"
CroagunkPicBack::     INCBIN "pic/monback/croagunkb.pic"
ToxicroakPicFront::   INCBIN "pic/bmon/toxicroak.pic"
ToxicroakPicBack::    INCBIN "pic/monback/toxicroakb.pic"
...
FennekinPicFront::    INCBIN "pic/bmon/fennekin.pic"
FennekinPicBack::     INCBIN "pic/monback/fennekinb.pic"
BraixenPicFront::     INCBIN "pic/bmon/braixen.pic"
BraixenPicBack::      INCBIN "pic/monback/braixenb.pic"
DelphoxPicFront::     INCBIN "pic/bmon/delphox.pic"
DelphoxPicBack::      INCBIN "pic/monback/delphoxb.pic"
FletchlingPicFront::  INCBIN "pic/bmon/fletchling.pic"
FletchlingPicBack::   INCBIN "pic/monback/fletchlingb.pic"
FletchinderPicFront:: INCBIN "pic/bmon/fletchinder.pic"
FletchinderPicBack::  INCBIN "pic/monback/fletchinderb.pic"
TalonflamePicFront::  INCBIN "pic/bmon/talonflame.pic"
TalonflamePicBack::   INCBIN "pic/monback/talonflameb.pic"
FlabebePicFront::     INCBIN "pic/bmon/flabebe.pic"
FlabebePicBack::      INCBIN "pic/monback/flabebeb.pic"
FloettePicFront::     INCBIN "pic/bmon/floette.pic"
FloettePicBack::      INCBIN "pic/monback/floetteb.pic"
FlorgesPicFront::     INCBIN "pic/bmon/florges.pic"
FlorgesPicBack::      INCBIN "pic/monback/florgesb.pic"
SkiddoPicFront::      INCBIN "pic/bmon/skiddo.pic"
SkiddoPicBack::       INCBIN "pic/monback/skiddob.pic"
GogoatPicFront::      INCBIN "pic/bmon/gogoat.pic"
GogoatPicBack::       INCBIN "pic/monback/gogoatb.pic"
PanchamPicFront::     INCBIN "pic/bmon/pancham.pic"
PanchamPicBack::      INCBIN "pic/monback/panchamb.pic"
PangoroPicFront::     INCBIN "pic/bmon/pangoro.pic"
PangoroPicBack::      INCBIN "pic/monback/pangorob.pic"
SpritzeePicFront::    INCBIN "pic/bmon/spritzee.pic"
SpritzeePicBack::     INCBIN "pic/monback/spritzeeb.pic"
AromatissePicFront::  INCBIN "pic/bmon/aromatisse.pic"
AromatissePicBack::   INCBIN "pic/monback/aromatisseb.pic"
SwirlixPicFront::     INCBIN "pic/bmon/swirlix.pic"
SwirlixPicBack::      INCBIN "pic/monback/swirlixb.pic"
SlurpuffPicFront::    INCBIN "pic/bmon/slurpuff.pic"
SlurpuffPicBack::     INCBIN "pic/monback/slurpuffb.pic"
InkayPicFront::       INCBIN "pic/bmon/inkay.pic"
InkayPicBack::        INCBIN "pic/monback/inkayb.pic"
MalamarPicFront::     INCBIN "pic/bmon/malamar.pic"
MalamarPicBack::      INCBIN "pic/monback/malamarb.pic"
SkrelpPicFront::      INCBIN "pic/bmon/skrelp.pic"
SkrelpPicBack::       INCBIN "pic/monback/skrelpb.pic"
DragalgePicFront::    INCBIN "pic/bmon/dragalge.pic"
DragalgePicBack::     INCBIN "pic/monback/dragalgeb.pic"
CarbinkPicFront::     INCBIN "pic/bmon/carbink.pic"
CarbinkPicBack::      INCBIN "pic/monback/carbinkb.pic"
PhantumpPicFront::    INCBIN "pic/bmon/phantump.pic"
PhantumpPicBack::     INCBIN "pic/monback/phantumpb.pic"
TrevenantPicFront::   INCBIN "pic/bmon/trevenant.pic"
TrevenantPicBack::    INCBIN "pic/monback/trevenantb.pic"
NoibatPicFront::      INCBIN "pic/bmon/noibat.pic"
NoibatPicBack::       INCBIN "pic/monback/noibatb.pic"
NoivernPicFront::     INCBIN "pic/bmon/noivern.pic"
NoivernPicBack::      INCBIN "pic/monback/noivernb.pic"
RowletPicFront::      INCBIN "pic/bmon/rowlet.pic"
RowletPicBack::       INCBIN "pic/monback/rowletb.pic"


SECTION "Pics 12", ROMX	; bank $39
...
CutieflyPicFront::    INCBIN "pic/bmon/cutiefly.pic"
CutieflyPicBack::     INCBIN "pic/monback/cutieflyb.pic"
RibombeePicFront::    INCBIN "pic/bmon/ribombee.pic"
RibombeePicBack::     INCBIN "pic/monback/ribombeeb.pic"
MudbrayPicFront::     INCBIN "pic/bmon/mudbray.pic"
MudbrayPicBack::      INCBIN "pic/monback/mudbrayb.pic"
MudsdalePicFront::    INCBIN "pic/bmon/mudsdale.pic"
MudsdalePicBack::     INCBIN "pic/monback/mudsdaleb.pic"
DewpiderPicFront::    INCBIN "pic/bmon/dewpider.pic"
DewpiderPicBack::     INCBIN "pic/monback/dewpiderb.pic"
AraquanidPicFront::   INCBIN "pic/bmon/araquanid.pic"
AraquanidPicBack::    INCBIN "pic/monback/araquanidb.pic"
SalanditPicFront::    INCBIN "pic/bmon/salandit.pic"
SalanditPicBack::     INCBIN "pic/monback/salanditb.pic"
SalazzlePicFront::    INCBIN "pic/bmon/salazzle.pic"
SalazzlePicBack::     INCBIN "pic/monback/salazzleb.pic"
DrampaPicFront::      INCBIN "pic/bmon/drampa.pic"
DrampaPicBack::       INCBIN "pic/monback/drampab.pic"
YamperPicFront::      INCBIN "pic/bmon/yamper.pic"
YamperPicBack::       INCBIN "pic/monback/yamperb.pic"
BoltundPicFront::     INCBIN "pic/bmon/boltund.pic"
BoltundPicBack::      INCBIN "pic/monback/boltundb.pic"
RolycolyPicFront::    INCBIN "pic/bmon/rolycoly.pic"
RolycolyPicBack::     INCBIN "pic/monback/rolycolyb.pic"
CarkolPicFront::      INCBIN "pic/bmon/carkol.pic"
CarkolPicBack::       INCBIN "pic/monback/carkolb.pic"
CoalossalPicFront::   INCBIN "pic/bmon/coalossal.pic"
CoalossalPicBack::    INCBIN "pic/monback/coalossalb.pic"
ImpidimpPicFront::    INCBIN "pic/bmon/impidimp.pic"
ImpidimpPicBack::     INCBIN "pic/monback/impidimpb.pic"
MorgremPicFront::     INCBIN "pic/bmon/morgrem.pic"
MorgremPicBack::      INCBIN "pic/monback/morgremb.pic"
GrimmsnarlPicFront::  INCBIN "pic/bmon/grimmsnarl.pic"
GrimmsnarlPicBack::   INCBIN "pic/monback/grimmsnarlb.pic"
SnomPicFront::        INCBIN "pic/bmon/snom.pic"
SnomPicBack::         INCBIN "pic/monback/snomb.pic"
FrosmothPicFront::    INCBIN "pic/bmon/frosmoth.pic"
FrosmothPicBack::     INCBIN "pic/monback/frosmothb.pic"
CetoddlePicFront::    INCBIN "pic/bmon/cetoddle.pic"
CetoddlePicBack::     INCBIN "pic/monback/cetoddleb.pic"
CetitanPicFront::     INCBIN "pic/bmon/cetitan.pic"
CetitanPicBack::      INCBIN "pic/monback/cetitanb.pic"
...
CranidosPicFront::    INCBIN "pic/bmon/cranidos.pic"
CranidosPicBack::     INCBIN "pic/monback/cranidosb.pic"
RampardosPicFront::   INCBIN "pic/bmon/rampardos.pic"
RampardosPicBack::    INCBIN "pic/monback/rampardosb.pic"
ShieldonPicFront::    INCBIN "pic/bmon/shieldon.pic"
ShieldonPicBack::     INCBIN "pic/monback/shieldonb.pic"
BastiodonPicFront::   INCBIN "pic/bmon/bastiodon.pic"
BastiodonPicBack::    INCBIN "pic/monback/bastiodonb.pic"


SECTION "Pics 13", ROMX	; bank $3A

TyruntPicFront::      INCBIN "pic/bmon/tyrunt.pic"
TyruntPicBack::       INCBIN "pic/monback/tyruntb.pic"
TyrantrumPicFront::   INCBIN "pic/bmon/tyrantrum.pic"
TyrantrumPicBack::    INCBIN "pic/monback/tyrantrumb.pic"
AmauraPicFront::      INCBIN "pic/bmon/amaura.pic"
AmauraPicBack::       INCBIN "pic/monback/amaurab.pic"
AurorusPicFront::     INCBIN "pic/bmon/aurorus.pic"
AurorusPicBack::      INCBIN "pic/monback/aurorusb.pic"
...
GiblePicFront::       INCBIN "pic/bmon/gible.pic"
GiblePicBack::        INCBIN "pic/monback/gibleb.pic"
GabitePicFront::      INCBIN "pic/bmon/gabite.pic"
GabitePicBack::       INCBIN "pic/monback/gabiteb.pic"
GarchompPicFront::    INCBIN "pic/bmon/garchomp.pic"
GarchompPicBack::     INCBIN "pic/monback/garchompb.pic"
...
GiratinaAlteredPicFront::    INCBIN "pic/bmon/giratina_altered.pic"
GiratinaAlteredPicBack::     INCBIN "pic/monback/giratina_alteredb.pic"
GiratinaOriginPicFront::    INCBIN "pic/bmon/giratina_origin.pic"
GiratinaOriginPicBack::     INCBIN "pic/monback/giratina_originb.pic"
MewtwoPicFront::      INCBIN "pic/bmon/mewtwo.pic"
MewtwoPicBack::       INCBIN "pic/monback/mewtwob.pic"
MewPicFront::         INCBIN "pic/bmon/mew.pic"
MewPicBack::          INCBIN "pic/monback/mewb.pic"
ArceusPicFront::      INCBIN "pic/bmon/arceus.pic"
ArceusPicBack::       INCBIN "pic/monback/arceusb.pic"


SECTION "bank3B", ROMX					; added new animations in a dedicated bank

INCLUDE "engine/battle/animations3.asm"

INCLUDE "data/animations3.asm"
