...
INCLUDE "constants/special_animation_constants.asm"
...
INCLUDE "constants/tm_compatibility_constants.asm"
INCLUDE "constants/experience_constants.asm"
INCLUDE "constants/daycare_groups_constants.asm"
