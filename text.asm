...
INCLUDE "text/maps/Route23HyperTrainingRoom.asm"
...
_DexSeenOwnedText::
	text "#DEX   Seen:@"
	TX_NUM wDexRatingNumMonsSeen, 2, 3			; use 2 bytes now
	text ""
	line "         Owned:@"
	TX_NUM wDexRatingNumMonsOwned, 2, 3			; use 2 bytes now
	db "@"
...
; add this for GHOSTs encountered on exterior maps
_GoAwayText::
	text "GHOST: Go away..."
	line "Go away..."
	prompt
...
; for moves like Mean Look
_CantEscapeNowText::
	text "<TARGET>"
	line "can't escape now!"
	prompt

; add this text for trapping moves
_TrappedByAttackText::
	text "<TARGET>"
	line "was trapped!"
	prompt
...
; add this text for trapping effect
_CantSwitchText::
	text "<USER> cannot"
	line "switch out!"
	prompt

; add this text for forced switches
_DraggedOutText::
	text "<TARGET>"
	line "was dragged out!"
	prompt

; add this text for switch moves
_ForcedEnemySwitchText::
	text "<TARGET>"
	line "went back to"
	cont "@"
	TX_RAM wTrainerName
...
; add this text for switch moves
_ForcedPlayerSwitchText::
	text "<TARGET>"
	line "went back to"
	cont "<PLAYER>!"
	prompt

; add this text for Reflect counter
_PlayerReflectFaded::
	text "Your POKéMON's"
	line "REFLECT faded!"
	prompt
...
; add this text for Reflect counter
_EnemyReflectFaded::
	text "Enemy POKéMON's"
	line "REFLECT faded!"
	prompt

; add this text for Light Screen counter
_PlayerLightScreenFell::
	text "Your POKéMON's"
	line "LIGHT SCREEN fell!"
	prompt

; add this text for Light Screen counter
_EnemyLightScreenFell::
	text "Enemy POKéMON's"
	line "LIGHT SCREEN fell!"
	prompt

; add this text for Mist counter
_PlayerMistWoreOff::
	text "Your POKéMON's"
	line "MIST wore off!"
	prompt
...
_TrickRoomOver::
	text "The twisted di-"
	line "mensions returned"
	cont "to normal."
	prompt

; add this for trick room
_TwistedDimensionsText::
	text "<USER>"
	line "twisted the"
	cont "dimensions!"
	prompt
...
; text for Biding turns
_StoringEnergyText::
	text "<USER>"
	line "is storing energy!"
	prompt

; text for fatigue-induced confusion
_ConfusedDueToFatigueText::
	text "<USER>"
...
_ExpShareDeactivatedText::
	text "It's turned OFF,"
	line "do you want to"
	cont "turn it ON?"
	done

_ExpShareActivatedText::
	text "It's turned ON,"
	line "do you want to"
	cont "turn it OFF?"
	done
...
_CantDepositLastNonFaintedMonText::
	text "You can't have"
	line "a party with only"
	cont "fainted #MON!"
	prompt
...
; warning text for when the player fills up his current box while catching pokemon
_PCBoxFullText::
	text "Hi, this is the"
	line "POKéMON STORAGE"
	cont "SYSTEM SERVICE."
	
	para "The last one you"
	line "sent has filled"
	cont "the current box."
...
; added this
_AlreadyGotThisPrizeText::
	text "You already got"
	line "this prize.@@"

; added this
_AlreadyGotThisTMText::
	text "You already got"
	line "this TM.@@"

_TMmartBuyingGreetingText::
	text "Take a look at"
	line "our TMs!@@"
...
; add this for Flame Wheel effect
_WasDefrostedText::
	text "<USER>"
	line "was defrosted!"
	prompt
...
_DisappearedInstantlyText::
	text ""
	line "vanished at once!"
	prompt
...
; update this text for new behaviour
_ConvertedTypeText::
	text "<USER>"
...
; in case Reflect Type gets added one day
_ReflectTypeText::
	text "<USER>'s"
	line "type changed to"
	cont "match"
	cont "<TARGET>'s!"
	prompt
	
_StatsChangesEliminatedText::
	text "All STATS changes"
	line "are eliminated!"
	prompt
...
INCLUDE "text/maps/BerryHouse.asm"
...
; add this for changing ARCEUS's type
_WhichTypeText::
	text "Which type shall"
	line "@"
	TX_RAM wcd6d
	text " become?"
	prompt
...
_BecameTypeText::
	...
	text " became"
	line "@"
	TX_RAM wcf4b + 2	; + 2 to skip the type symbol (followed by 1 blank space) that is present in the item name used by ORIGIN PLATE
	text "-type!"
	prompt
...
; add this for changing Giratina's Forme
_ChangedFormeText::
	TX_RAM wcf4b
	text ""
	line "changed into its"
	cont "@"
	TX_RAM wcd6d
	text " FORME!@"
	TX_SFX_ITEM_1
...
; mutualized this bit of text for the new EV reducing Berries
_VitaminStatText::
	TX_RAM wcd6d
	text "'s"
	line "@"
...
_AfterTrade2Text::
	...
	text " you"
	line "traded to me"
	cont "didn't evolve!"			; fixed erroneous text
	
	para "I thought it"				; fixed erroneous text
	line "would..."					; fixed erroneous text
	done
...
INCLUDE "text/battle_facility.asm"


SECTION "Pokedex Text 1", ROMX ; BANK $2b

INCLUDE "text/pokedex1.asm"


SECTION "Pokedex Text 2", ROMX ; BANK $3b

INCLUDE "text/pokedex2.asm"


SECTION "Pokedex Text 3", ROMX ; BANK $3c

INCLUDE "text/pokedex3.asm"
