...
; use a distinct script to handle the articuno flag in case other static mons get added to the map
SeafoamIslands5Script5:
	call SeafoamIslands5Script4
...
ArticunoTrainerHeader:
	...
	dw ARTICUNO				; use this to store the static mon id
...
ArticunoText:
	...
	call TalkToTrainer
	ld a, $5							; run SeafoamIslands5Script5 after Articuno battle to set the flag in case it was caught
	ld [wSeafoamIslandsB4FCurScript], a
	jp TextScriptEnd
...
ArticunoBattleText:
	...
	TX_ASM
	ld bc, ARTICUNO					; replaced a with bc to handle 2 bytes species IDs
	call PlayCry
