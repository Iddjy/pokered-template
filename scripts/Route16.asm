...
Route16Script0:
	...
	ld a, $c							; update index to take into account additional objects on the map
	ld [hSpriteIndexOrTextID], a
	call DisplayTextID
	ld bc, SNORLAX						; to handle 2 bytes species IDs
...
Route16Script3:
	...
	cp $2
	jr z, .asm_599a8
	ld a, $d							; updated to take into account addiotnal objects on the map
	ld [hSpriteIndexOrTextID], a
	call DisplayTextID
.asm_599a8
