...
CeladonGameCornerText2:
	...
	and a
	jr nz, .buy500
	ld [hMoney], a						; here a is already zero
	ld [hMoney + 2], a
	ld a, $10
	ld [hMoney + 1], a
	call HasEnoughMoney
	jr nc, .hasEnoughFor50
...
.buy500
	...
	ld a, $1
	ld [hMoney], a
	call HasEnoughMoney					; add another check here since the cost is different
	jr nc, .hasEnoughFor500
	ld hl, CeladonGameCornerText_48d31
	jr .asm_48d1c
.hasEnoughFor500
	xor a
	...
	predef AddBCDPredef
.bought
	ld a, SFX_PURCHASE					; there was something missing...
