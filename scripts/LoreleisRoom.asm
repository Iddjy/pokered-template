...
LoreleiText1:
	...
	jr c, .next
	ld hl, wMapSpriteExtraData + 1	; Lorelei is the 1st map sprite, each sprite has 2 bytes of extra data, and we want the second byte associated with it
	inc [hl]						; use the second team
.next
	ld hl, LoreleiTrainerHeader0
	call TalkToTrainer
	jp TextScriptEnd
