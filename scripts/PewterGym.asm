...
PewterGymText1:
	...
	jr z, .asm_5c46a
	CheckEventReuseA EVENT_GOT_TM84
	jr nz, .asm_5c462
...
PewterGymText4:
	TX_FAR _TM84PreReceiveText
	db "@"

PewterGymText5:
	TX_FAR _ReceivedTM84Text
	TX_SFX_ITEM_1
	TX_FAR _TM84ExplanationText
	db "@"

PewterGymText6:
	TX_FAR _TM84NoRoomText
	db "@"
