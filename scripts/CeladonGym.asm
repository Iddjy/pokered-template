...
CeladonGymText1:
	...
	jr z, .asm_48a2d
	CheckEventReuseA EVENT_GOT_TM93
	jr nz, .asm_48a25
...
CeladonGymText_48a63:
	...
	TX_SFX_LEVEL_UP					; add sound effect when receiving the badge
	db "@"
...
TM93Text:
	TX_FAR _ReceivedTM93Text
	TX_SFX_ITEM_1
	TX_FAR _TM93ExplanationText
	db "@"

TM93NoRoomText:
	TX_FAR _TM93NoRoomText
	db "@"
