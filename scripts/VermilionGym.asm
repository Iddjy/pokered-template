...
VermilionGymText1:
	...
	jr z, .asm_5cb39
	CheckEventReuseA EVENT_GOT_TM64
	jr nz, .asm_5cb31
...
VermilionGymText7:
	TX_FAR _ReceivedTM64Text
	TX_SFX_KEY_ITEM
	TX_FAR _TM64ExplanationText
	db "@"

VermilionGymText8:
	TX_FAR _TM64NoRoomText
	db "@"

ReceivedThunderbadgeText:
	TX_FAR _ReceivedThunderbadgeText
	TX_SFX_LEVEL_UP						; play sound effect when receiving badge
	db "@"
