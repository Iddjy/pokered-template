...
; add this to make an item appear when cutting a certain patch of grass
Route21Script0:
	CheckEvent EVENT_ROUTE21_GRASS_PATCH_CUT
	jp nz, CheckFightingMapTrainers
	overworldMapCoord hl, 5, 3, ROUTE_21_WIDTH	; coordinates of the block where the item is located
	ld a, [hl]									; get block ID at those coordinates
	cp $0b										; check against grass tiles block
	jp z, CheckFightingMapTrainers				; if the item is on a grass tiles block, nothing to do
	SetEvent EVENT_ROUTE21_GRASS_PATCH_CUT
	ld a, HS_ROUTE_21_ITEM_1
