...
SilphCo2Text1:
	TX_ASM
	CheckEvent EVENT_GOT_TM59
	jr nz, .asm_59de4
	ld hl, SilphCo2Text_59ded
	call PrintText
	lb bc, TM_59, 1
	call GiveItem
	ld hl, TM59NoRoomText
	jr nc, .asm_59de7
	SetEvent EVENT_GOT_TM59
	ld hl, ReceivedTM59Text
	jr .asm_59de7
.asm_59de4
	ld hl, TM59ExplanationText
.asm_59de7
	call PrintText
	jp TextScriptEnd
...
ReceivedTM59Text:
	TX_FAR _ReceivedTM59Text
	TX_SFX_ITEM_1
	db "@"

TM59ExplanationText:
	TX_FAR _TM59ExplanationText
	db "@"

TM59NoRoomText:
	TX_FAR _TM59NoRoomText
	db "@"
