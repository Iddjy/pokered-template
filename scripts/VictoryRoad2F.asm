...
; use a distinct script to handle the moltres flag in case other static mons get added to the map
VictoryRoad2Script2:
	call VictoryRoad2Script1
...
MoltresTrainerHeader:
	...
	dw MOLTRES 				; use this to store the static mon id
...
MoltresText:
	...
	call TalkToTrainer
	ld a, 3								; run VictoryRoad2Script2 after Moltres battle to set the flag in case it was caught
	ld [wVictoryRoad2FCurScript], a
	ld [wCurMapScript], a
	jp TextScriptEnd
...
MoltresBattleText:
	...
	TX_ASM
	ld bc, MOLTRES				; replaced a with bc to handle 2 bytes species IDs
	call PlayCry
