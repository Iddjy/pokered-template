...
; replacement for tmlearn macro allowing the use of binary constants with the TM number and move name
; so that updating TM compatibilities is easier
tmcompatibility: MACRO
x = 0
i = 0
	REPT _NARG
x = x | (\1 << i)
...
; added this macro to simplify party data after making species ids 2 bytes
partymember: MACRO
	dw \1			; species id
	db \2			; level
	db \3			; move 1
...
; added this macro because I keep mixing up the two numbers
trainerview: MACRO
	db (\1 << 4)
ENDM
