...
auto   EQUS "db $4c," ; Scroll to the next line automatically (no button press needed)
...
TX_SFX_LEVEL_UP          EQUS "db $14"
TX_SFX_SS_ANNE_HORN      EQUS "db $15"
TX_SFX_HEALING_MACHINE   EQUS "db $16"
